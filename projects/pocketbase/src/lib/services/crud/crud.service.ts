import { BaseQueryParams, FullListQueryParams, ListQueryParams } from '../../models/query-params';
import { BaseModel } from '../../models/base-model';
import { ListResult } from '../../models/list-result';
import { BaseCrudService } from '../base-crud/base-crud.service';

export abstract class CrudService<M extends BaseModel> extends BaseCrudService<M> {
	/**
