...
export class LogService extends BaseService {
	...
	getRequest(
		...
		return this.client
			.send('/api/logs/requests/' + encodeURIComponent(id), {
				method: 'GET',
				params: queryParams
			})
	 ...
	 */
	getRequestsStats(
		queryParams: LogStatsQueryParams = {}
	): Promise<Array<HourlyStats>> {
		return this.client
			.send('/api/logs/requests/stats', {
				method: 'GET',
				params: queryParams
			})
