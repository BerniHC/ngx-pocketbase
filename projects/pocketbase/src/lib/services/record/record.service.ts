...
import { UnsubscribeFunc } from '../realtime/realtime.service';
...
export class RecordService extends CrudService<Record> {
    readonly collectionIdOrName: string;

    constructor(client: PocketBaseService, collectionIdOrName: string) {
        super(client);
     ...
     * @inheritdoc
     */
    override getFullList<T = Record>(queryParams?: RecordFullListQueryParams): Promise<Array<T>>

    /**
     * @inheritdoc
     */
    override getFullList<T = Record>(batch?: number, queryParams?: RecordListQueryParams): Promise<Array<T>>

    /**
     * @inheritdoc
     */
    override getFullList<T = Record>(batchOrQueryParams?: number|RecordFullListQueryParams, queryParams?: RecordListQueryParams): Promise<Array<T>> {
     ...
     * @inheritdoc
     */
    override getList<T = Record>(page = 1, perPage = 30, queryParams: RecordListQueryParams = {}): Promise<ListResult<T>> {
     ...
     * @inheritdoc
     */
    override getFirstListItem<T = Record>(filter: string, queryParams: RecordListQueryParams = {}): Promise<T> {
     ...
     * @inheritdoc
     */
    override getOne<T = Record>(id: string, queryParams: RecordQueryParams = {}): Promise<T> {
     ...
     * @inheritdoc
     */
    override create<T = Record>(bodyParams = {}, queryParams: RecordQueryParams = {}): Promise<T> {
     ...
     */
    override update<T = Record>(id: string, bodyParams = {}, queryParams: RecordQueryParams = {}): Promise<T> {
     ...
     */
    override delete(id: string, queryParams: BaseQueryParams = {}): Promise<boolean> {
