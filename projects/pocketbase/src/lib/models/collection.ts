...
export class Collection extends BaseModel {
	...
	override $load(data: { [key: string]: any }) {
		...
		this.options =
			typeof data['options'] !== 'undefined' && data['options'] !== null
				? data['options']
				: {};
		...
		// rules
		this.listRule =
			typeof data['listRule'] === 'string' ? data['listRule'] : null;
		this.viewRule =
			typeof data['viewRule'] === 'string' ? data['viewRule'] : null;
		this.createRule =
			typeof data['createRule'] === 'string' ? data['createRule'] : null;
		this.updateRule =
			typeof data['updateRule'] === 'string' ? data['updateRule'] : null;
		this.deleteRule =
			typeof data['deleteRule'] === 'string' ? data['deleteRule'] : null;
